...
namespace Projet_2._0.Levels
{
    public class W2L1
    {
        ...
        public W2L1(Vector2 Position)
        {
            ...
            w2l1.Add(new Rectangle(Res.gI().ScaleX(511), Res.gI().ScaleY(251), Res.gI().ScaleX(25), Res.gI().ScaleY(226)));
            ...
            w2l1.Add(new Rectangle(Res.gI().ScaleX(267), Res.gI().ScaleY(755), Res.gI().ScaleX(97), Res.gI().ScaleY(218)));
